...
#include <time.h>
  ...
  printf("Diferença: \033[1;33m%.2d Área km²\033[0m\n",Media2);

  if ( Area1 > Area2 ){
    printf("Vencedor é %s: \033[1;33m%.1f Área km²\033[0m\n",Capital1, Area1);
  } else {
    printf("Vencedor é %s: \033[1;33m%.1f Área km²\033[0m\n\n",Capital2, Area2);
  }
  break;
  ...
  if ( DensidadePopulacional1 < DensidadePopulacional2 ){
    printf("Vencedor é %s: \033[1;33m%.2f\033[0m\n",Capital1, DensidadePopulacional1);
  } else if ( DensidadePopulacional2 < DensidadePopulacional1 ){
    printf("Vencedor é %s: \033[1;33m%.2f\033[0m\n\n",Capital2, DensidadePopulacional2);
  } else {
  ...
  if ( SuperPoder1 > SuperPoder2 ){
    printf("Vencedor é %s: \033[1;33m%.2f De Poder.\033[0m\n",Capital1, SuperPoder1);
  } else {
  ...
  if ( PontosTuristicos1 > PontosTuristicos2 ){
    printf("Vencedor é %s: \033[1;33m%.2u Lugares\033[0m\n",Capital1, PontosTuristicos1);
  } else {
